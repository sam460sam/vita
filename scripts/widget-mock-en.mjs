...
const REM=[['08:00','Water'],['09:00','Daily quote'],['13:00','Workout'],['18:00','Journal'],['21:00','Weight']];
const TODO=['Call the movers','Ship to production','Book the dentist','Buy living-room lamps','TypeScript exercises'];
 ...
 *{margin:0;box-sizing:border-box;-webkit-font-smoothing:antialiased;font-family:-apple-system,system-ui,sans-serif}
 ...
 <div class=grid>
   <div class="wrap"><div class="w medium"><div class=mrow>${ring(0.6)}
     <div class=mcol><div class=cap>${drop} Water</div><div class=big>1.2L</div><div class=subt>Goal 2.0L</div>
       <div class=btns><div class=btn>＋ Glass</div><div class=btn>＋ 1 L</div></div></div></div></div></div>
   <div class=rowsmall>
     <div class="w small"><div class=cap>${drop} Water</div><div class=big>1.2L</div><div class=subt>60% · 2.0L</div><div class=btns><div class=btn>＋ Glass</div></div></div>
   ...
   <div class=rowsmall>
     <div class="wrap" style="flex:1"><div class="w large" style="height:248px"><div class=cap>${bell} Reminders</div><div style="margin-top:6px">${remRows(5)}</div></div><span class=tag>Today</span></div>
   </div>
 </div>
...
await p.screenshot({path:'store/widgets/home-mock-en.png'});
