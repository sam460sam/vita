...
// ============================================================================
import { HeartPulse, Scale, CheckSquare, Sprout, Wallet, BookHeart, Target, CalendarDays, StickyNote, Droplet, Compass, type LucideIcon } from 'lucide-react';
...
export const MODULE_CATALOG: Record<ModuleId, ModuleDef> = {
  ...
  personalita: { id: 'personalita', to: '/personalita', labelKey: 'nav.personality', shortKey: 'nav.personality.short', descKey: 'module.personalita.desc', icon: Compass, accent: 'var(--c-personality)' },
