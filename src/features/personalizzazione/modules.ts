...
// ============================================================================
import { HeartPulse, Scale, CheckSquare, Sprout, Wallet, BookHeart, Target, CalendarDays, StickyNote, Droplet, ClipboardList, type LucideIcon } from 'lucide-react';
...
export const MODULE_CATALOG: Record<ModuleId, ModuleDef> = {
  abitudini: { id: 'abitudini', to: '/abitudini', labelKey: 'nav.habits', shortKey: 'nav.habits.short', descKey: 'module.abitudini.desc', icon: Sprout, accent: 'var(--c-habit)' },
  ...
  personalita: { id: 'personalita', to: '/personalita', labelKey: 'nav.personality', shortKey: 'nav.personality.short', descKey: 'module.personalita.desc', icon: ClipboardList, accent: 'var(--c-personality)' },
