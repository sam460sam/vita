      ...
      <Screen>
        {list.length === 0 ? (
          ...
          <>
            ...
            <button onClick={() => setEditing('new')} className="w-full mt-1 h-[52px] rounded-2xl text-white font-bold text-[15.5px] flex items-center justify-center gap-2 active:scale-[0.98] transition-transform shadow-card" style={{ background: 'linear-gradient(180deg, #6FBE6F, #2F7D43)' }}>
