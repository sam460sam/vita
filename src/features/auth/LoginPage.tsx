  ...
  return (
    <div className="min-h-screen bg-app flex flex-col items-center justify-center px-6 py-12">
      ...
      <div className="flex flex-col items-center mb-10">
        ...
        <p className="text-[14px] text-ink-3 mt-1.5 text-center max-w-[240px] leading-relaxed">
          Gestisci pavimentazioni e cantieri dal tuo telefono
        </p>
      </div>
      ...
      {/* Legal */}
      <p className="absolute bottom-8 text-[11px] text-ink-3 text-center px-8 leading-relaxed">
