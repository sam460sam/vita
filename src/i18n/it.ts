...
export const it = {
  ...
  'workout.minimize': 'Riduci (continua in background)',
  'workout.ongoing': 'Allenamento in corso',
  'workout.discard': 'Annulla allenamento',
  'workout.discardConfirm': 'Vuoi annullare questo allenamento? Non verrà salvato.',
