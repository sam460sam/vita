...
export const it = {
  ...
  // Cantieri — cement flooring contractor module
  'nav.cantiere': 'Cantieri',
  'cantiere.title': 'Cantieri',
  'cantiere.nuovo': 'Nuovo cantiere',
  'cantiere.empty.title': 'Nessun cantiere',
  'cantiere.empty.desc': 'Aggiungi il primo cantiere',
  'cantiere.cliente': 'Cliente',
  'cantiere.telefono': 'Telefono',
  'cantiere.indirizzo': 'Indirizzo',
  'cantiere.mq': 'm²',
  'cantiere.spessore': 'Spessore (cm)',
  'cantiere.tipoUso': 'Utilizzo',
  'cantiere.importo': 'Importo (€)',
  'cantiere.acconto': 'Acconto (€)',
  'cantiere.dataPrevista': 'Data prevista',
  'cantiere.dataComp': 'Data completamento',
  'cantiere.note': 'Note',
  'cantiere.stato': 'Stato',
  'cantiere.pagamento': 'Pagamento',
  'cantiere.daRiscuotere': 'Da riscuotere',
  'cantiere.attivi': 'Cantieri attivi',
  'cantiere.salva': 'Salva cantiere',
  'cantiere.salvato': 'Cantiere salvato',
  'cantiere.eliminato': 'Cantiere eliminato',
  'cantiere.elimina': 'Elimina cantiere',
  'cantiere.modificato': 'Cantiere aggiornato',
  'cantiere.s.preventivo': 'Preventivo',
  'cantiere.s.confermato': 'Confermato',
  'cantiere.s.in_corso': 'In corso',
  'cantiere.s.completato': 'Completato',
  'cantiere.s.contestato': 'Contestato',
  'cantiere.p.da_pagare': 'Da pagare',
  'cantiere.p.parziale': 'Parziale',
  'cantiere.p.saldato': 'Saldato',
  'cantiere.uso.industriale': 'Industriale',
  'cantiere.uso.residenziale': 'Residenziale',
  'cantiere.uso.esterno': 'Esterno',
  'cantiere.uso.garage': 'Garage',
  'cantiere.uso.altro': 'Altro',
  'cantiere.operaiAssegnati': 'Operai assegnati',
  'cemento.title': 'Calcola cemento',
  'cemento.m3': 'm³ stimati',
  'cemento.classe': 'Classe cemento',
  'cemento.additivi': 'Additivi',
  'cemento.dataConsegna': 'Data consegna',
  'cemento.ora': 'Ora consegna',
  'cemento.copia': 'Copia messaggio WhatsApp',
  'cemento.copiato': 'Copiato!',
  'verbale.title': 'Verbale di consegna',
  'verbale.foto': 'Foto del lavoro',
  'verbale.aggiungiFoto': 'Aggiungi foto',
  'verbale.checklist': 'Conformità lavoro',
  'verbale.firma': 'Firma cliente',
  'verbale.pulisci': 'Pulisci firma',
  'verbale.salva': 'Salva verbale',
  'verbale.salvato': 'Verbale salvato',
  'operai.title': 'Operai',
  'operai.nuovo': 'Nuovo operaio',
  'operai.nome': 'Nome',
  'operai.telefono': 'Telefono',
  'operai.specializzazioni': 'Specializzazioni',
  'operai.valutazione': 'Valutazione (privata)',
  'operai.note': 'Note private',
  'operai.empty.title': 'Nessun operaio',
  'operai.empty.desc': 'Aggiungi i tuoi collaboratori fidati',
  'operai.salva': 'Salva operaio',
  'operai.salvato': 'Operaio salvato',
  'operai.eliminato': 'Operaio eliminato',
