...
export const en: Record<TKey, string> = {
  ...
  'nav.cantiere': 'Job sites',
  'cantiere.title': 'Job sites',
  'cantiere.nuovo': 'New job site',
  'cantiere.empty.title': 'No job sites',
  'cantiere.empty.desc': 'Add your first job site',
  'cantiere.cliente': 'Client',
  'cantiere.telefono': 'Phone',
  'cantiere.indirizzo': 'Address',
  'cantiere.mq': 'm²',
  'cantiere.spessore': 'Thickness (cm)',
  'cantiere.tipoUso': 'Usage',
  'cantiere.importo': 'Amount (€)',
  'cantiere.acconto': 'Deposit (€)',
  'cantiere.dataPrevista': 'Planned date',
  'cantiere.dataComp': 'Completion date',
  'cantiere.note': 'Notes',
  'cantiere.stato': 'Status',
  'cantiere.pagamento': 'Payment',
  'cantiere.daRiscuotere': 'To collect',
  'cantiere.attivi': 'Active sites',
  'cantiere.salva': 'Save job site',
  'cantiere.salvato': 'Job site saved',
  'cantiere.eliminato': 'Job site deleted',
  'cantiere.elimina': 'Delete job site',
  'cantiere.modificato': 'Job site updated',
  'cantiere.s.preventivo': 'Quote',
  'cantiere.s.confermato': 'Confirmed',
  'cantiere.s.in_corso': 'In progress',
  'cantiere.s.completato': 'Completed',
  'cantiere.s.contestato': 'Disputed',
  'cantiere.p.da_pagare': 'Unpaid',
  'cantiere.p.parziale': 'Partial',
  'cantiere.p.saldato': 'Paid',
  'cantiere.uso.industriale': 'Industrial',
  'cantiere.uso.residenziale': 'Residential',
  'cantiere.uso.esterno': 'Outdoor',
  'cantiere.uso.garage': 'Garage',
  'cantiere.uso.altro': 'Other',
  'cantiere.operaiAssegnati': 'Assigned workers',
  'cemento.title': 'Concrete calculator',
  'cemento.m3': 'Estimated m³',
  'cemento.classe': 'Concrete class',
  'cemento.additivi': 'Additives',
  'cemento.dataConsegna': 'Delivery date',
  'cemento.ora': 'Delivery time',
  'cemento.copia': 'Copy WhatsApp message',
  'cemento.copiato': 'Copied!',
  'verbale.title': 'Delivery report',
  'verbale.foto': 'Work photos',
  'verbale.aggiungiFoto': 'Add photo',
  'verbale.checklist': 'Work compliance',
  'verbale.firma': 'Client signature',
  'verbale.pulisci': 'Clear signature',
  'verbale.salva': 'Save report',
  'verbale.salvato': 'Report saved',
  'operai.title': 'Workers',
  'operai.nuovo': 'New worker',
  'operai.nome': 'Name',
  'operai.telefono': 'Phone',
  'operai.specializzazioni': 'Skills',
  'operai.valutazione': 'Rating (private)',
  'operai.note': 'Private notes',
  'operai.empty.title': 'No workers',
  'operai.empty.desc': 'Add your trusted workers',
  'operai.salva': 'Save worker',
  'operai.salvato': 'Worker saved',
  'operai.eliminato': 'Worker deleted',
